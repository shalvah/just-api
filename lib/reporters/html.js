...
const { INDICATORS } = require('./base');
const { escapeHTML, doesDirectoryExist, prettifyRequestLog } = require('./../utils');
const he = require('he');

const { buildHTML } = require('./html-src/template');
...
module.exports = class HTMLReporter {
    ...
    constructor(launcher, opts = {}) {
        ...
        launcher.on('end', function () {
            ...
            try {
                let outputDirectory = this.reporterOptions.htmlReportDir || '.justapi_reports';

...
const { assertFileValidity,
     loadModule,
     runModuleFunction,
     runInlineFunction } =  require('./utils');
const Spec = require('./spec');
const SuiteDependency = require('./suite-dependency');
...
module.exports = class Suite extends EventEmitter {
    ...
    loadFileAndValidateSchema() {
        ...
        const suiteSchemaDefinition = path.resolve(__dirname, './schema/suite.json');
    ...
    async configure() {
        ...
        const suiteConfigSchemaDefinition = path.resolve(__dirname, './schema/suite-config.json');

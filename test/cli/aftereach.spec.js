...
describe('suite configuration', function () {
    ...
    it('module sync success', function () {
        let result = runConfigSuite('hooks/aftereach/aftereach.module.success.suite.js');
    ...
    it('module sync failure', function () {
        let result = runConfigSuite('hooks/aftereach/aftereach.module.failure.suite.js');
    ...
    it('module async success', function () {
        let result = runConfigSuite('hooks/aftereach/aftereach.module.async.success.suite.js');
        expect(result.exitCode).to.equal(0);
        expect(result.terminationSignal).to.be.a('null');
        const report = fs.readFileSync(result.jsonReport);
        let reportData = JSON.parse(report);
    ...
    it('module async failure', function () {
        let result = runConfigSuite('hooks/aftereach/aftereach.module.async.failure.suite.js');
        expect(result.exitCode).to.equal(1);
        expect(result.terminationSignal).to.be.a('null');
        const report = fs.readFileSync(result.jsonReport);
        let reportData = JSON.parse(report);
    ...
    it('inline sync success', function () {
        let result = runConfigSuite('hooks/aftereach/aftereach.inline.success.suite.js');
        expect(result.exitCode).to.equal(0);
        expect(result.terminationSignal).to.be.a('null');
        const report = fs.readFileSync(result.jsonReport);
        let reportData = JSON.parse(report);
    ...
    it('inline sync failure', function () {
        let result = runConfigSuite('hooks/aftereach/aftereach.inline.failure.suite.js');
        expect(result.exitCode).to.equal(1);
        expect(result.terminationSignal).to.be.a('null');
        const report = fs.readFileSync(result.jsonReport);
        let reportData = JSON.parse(report);
    ...
    it('inline async success', function () {
        let result = runConfigSuite('hooks/aftereach/aftereach.inline.async.success.suite.js');
        expect(result.exitCode).to.equal(0);
        expect(result.terminationSignal).to.be.a('null');
        const report = fs.readFileSync(result.jsonReport);
        let reportData = JSON.parse(report);
    ...
    it('inline async failure', function () {
        let result = runConfigSuite('hooks/aftereach/aftereach.inline.async.failure.suite.js');
        expect(result.exitCode).to.equal(1);
        expect(result.terminationSignal).to.be.a('null');
        const report = fs.readFileSync(result.jsonReport);
        let reportData = JSON.parse(report);
